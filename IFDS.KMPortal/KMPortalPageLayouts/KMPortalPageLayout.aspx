	...
	<div class="welcome blank-wp">
		...
		<div class="ms-table ms-fullWidth">
			<div class="tableCol-75">
                ...
                <div class="ms-table ms-fullWidth">
					<div class="cell-margin tableCol-50">
						<WebPartPages:WebPartZone runat="server" Title="bottomleftrow" ID="BottomLeftRow" />
					</div>
					<div class="cell-margin tableCol-50">
						<WebPartPages:WebPartZone runat="server" Title="bottomrightrow" ID="BottomRightRow" />
					</div>
				</div>
